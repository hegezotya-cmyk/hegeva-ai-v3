...
assert(page.includes("<AIBotStudio afterContent") && page.includes("<main") && studio.includes("<AppShell>") && studio.includes("{afterContent}</AppShell>"), "workflow content is not inside app shell main")
