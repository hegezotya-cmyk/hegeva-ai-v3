...
const pulse=f.createPulseBrief({userId:"u",workspaceId:"w",projectId:"p",approvedMemoryIds:["m"],currentGoal:"Continue PawFlow"});assert.equal(pulse.needsUser,undefined);assert(pulse.continuity.length===2)
