...
const assert=(v,m)=>{if(!v)throw new Error(m)}; const route=source.slice(source.indexOf('url.pathname === "/api/ai-bot/approve"'),source.indexOf('url.pathname === "/api/ai-bot/execute"'))
