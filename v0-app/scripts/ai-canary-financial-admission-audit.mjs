...
if (!files.includes("0014_ai_canary_financial_guard.sql") || files.indexOf("0014_ai_canary_financial_guard.sql") !== files.indexOf("0013_ai_bot_execution.sql") + 1) throw new Error("AI canary migration ordering missing")
