...
for (const token of ["useWorkspaceData", "video_ad_specs", "validateVideoBrief", "createVideoStoryboard", "setItems", "duplicate", "provider approval", "not a rendered video", "aria-live", "navigationCopy", "navigation.briefPlaceholder", "window.confirm(navigation.deleteConfirm)"]) {
