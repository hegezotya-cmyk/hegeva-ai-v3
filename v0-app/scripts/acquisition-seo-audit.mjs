...
const config=read("lib/acquisition-pages.ts"),view=read("components/acquisition/acquisition-page.tsx"),sitemap=read("app/sitemap.ts"),robots=read("app/robots.ts"),worker=read("../src/index.js"),pricing=read("app/pricing/page.tsx"),measure=read("components/acquisition/acquisition-attribution.tsx")
