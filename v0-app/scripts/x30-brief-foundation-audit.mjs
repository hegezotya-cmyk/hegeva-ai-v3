...
assert(page.includes('disabled={briefState!=="ready-for-review"}') && page.includes('aria-disabled={briefState!=="ready-for-review"}') && page.includes('disabled={isGenerating||briefState!=="preview-only"}'), "approval and generation gates must follow the canonical review states")
