...
assert(page.includes('disabled={briefState!=="ready-for-review"}') && page.includes('aria-disabled={briefState!=="ready-for-review"}'), "preview approval must be disabled before review")
