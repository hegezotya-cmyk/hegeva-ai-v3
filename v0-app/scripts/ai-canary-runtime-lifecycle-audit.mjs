...
assert(route.includes("flags.ownerCanaryEnabled") && source.includes("parseProviderFlags"), "independent owner-canary flag gate missing")
...
const providerEnv = { AI_PROVIDER_ENABLED: "enabled", AI_GLOBAL_KILL_SWITCH: "disabled", AI_OWNER_CANARY_ENABLED: "disabled", AI_PROVIDER_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast", AI_TIMEOUT_MS: "1", AI_MAX_OUTPUT_TOKENS: "100", AI_MAX_INPUT_TOKENS: "200", AI_DAILY_REQUEST_CEILING: "1", AI_PER_USER_CEILING: "1", AI_PER_WORKSPACE_CEILING: "1", AI_CONCURRENCY_CEILING: "1", AI_DOCUMENTED_DAILY_NEURON_ALLOCATION: "10000", AI_DAILY_NEURON_CEILING: "7000" }
