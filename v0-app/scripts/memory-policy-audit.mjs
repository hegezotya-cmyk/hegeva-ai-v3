...
assert.deepEqual(authorizeMemoryWrite({...record,createdAt:"invalid"},{ownerId:"owner-1",approval:"approved",allowedScopes:["approved-user"],now}),{allowed:false,reason:"invalid-timestamp"})
...
console.log("Memory policy audit passed: explicit consent, ownership isolation, scope control, provenance, valid timestamps, retention and expiry filtering")
