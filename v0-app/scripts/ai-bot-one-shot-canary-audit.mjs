...
assert(providerSource.includes("requestCeiling > CANARY_BOUNDS.maxRequests") && providerSource.includes("userCeiling > CANARY_BOUNDS.maxRequests") && providerSource.includes("workspaceCeiling > CANARY_BOUNDS.maxRequests") && providerSource.includes("maxRequests: 1"), "one-request ceilings missing")
