...
assert(page.includes("<AppShell>") && page.includes("<main") && page.indexOf("<AIBotOwnerApprovalPanel") < page.indexOf("<AIBotExecution"), "workflow hierarchy is not inside main content")
