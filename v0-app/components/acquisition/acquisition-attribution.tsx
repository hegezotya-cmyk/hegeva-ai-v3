...
export type AnalyticsEvent="landing_page_view"|"registration_start"|"pricing_view"|"demo_entry_click"|"demo_workspace_view"|"demo_business_switch"|"demo_signup_click"
...
export function saveDemoRegistrationContext(businessType:string){
  try{sessionStorage.setItem(DEMO_REGISTRATION_KEY,JSON.stringify({origin:"demo",businessType,at:Date.now()}))}catch{}
}
