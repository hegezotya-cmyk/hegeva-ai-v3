...
const projectionCopy={
 en:{records:"Workspace records available",empty:"No workspace data available",continuity:"Workspace continuity is ready for review.",approval:"Awaiting owner approval",localApproval:"Local preview; approval required",next:"Review and approve the next mission step.",cloud:"Authenticated cloud workspace",local:"Local workspace · not cloud-synced"},
 hu:{records:"A munkaterület adatai elérhetők",empty:"Nincs elérhető munkaterületi adat",continuity:"A munkaterület folytonossága áttekintésre kész.",approval:"Tulajdonosi jóváhagyásra vár",localApproval:"Helyi előnézet; jóváhagyás szükséges",next:"Tekintsd át és hagyd jóvá a következő küldetéslépést.",cloud:"Hitelesített felhő-munkaterület",local:"Helyi munkaterület · nincs felhőszinkron"},
 de:{records:"Workspace-Daten verfügbar",empty:"Keine Workspace-Daten verfügbar",continuity:"Workspace-Kontinuität zur Prüfung bereit.",approval:"Warten auf Inhaberfreigabe",localApproval:"Lokale Vorschau; Freigabe erforderlich",next:"Nächsten Missionsschritt prüfen und freigeben.",cloud:"Authentifizierter Cloud-Workspace",local:"Lokaler Workspace · nicht cloud-synchronisiert"},
...
const onboardingCopy={
 ...
 de:{title:"Workspace starten",sub:"Schließen Sie diese echten ersten Schritte ab. Der Fortschritt basiert auf gespeicherten Workspace-Daten.",progress:"erledigt",customer:"Ersten Kunden hinzufügen",task:"Erste Aufgabe planen",invoice:"Erstes Angebot oder erste Rechnung erstellen",assistant:"HEGEVA die erste Frage stellen"},
...
export function OperatingCenter(){
  ...
  const {data: coreResponse, status: coreStatus, identity: coreIdentity, revision: coreRevision, refresh: refreshCore} = useCoreDecision()
