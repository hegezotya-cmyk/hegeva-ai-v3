...
import { BarChart3, Blocks, Bot, CalendarDays, Command, FileText, Home, MessageSquareText, Settings, Sparkles, Users } from "lucide-react"
...
const copy={
 en:{primary:"Core systems",operations:"Operations",home:"Home",command:"Command Center",assistant:"Assistant",studio:"App Studio",business:"Business Hub",customers:"Customers",documents:"Documents",planner:"Planner",reports:"Reports",messages:"Messages",pricing:"Pricing & Plans",account:"Account",ready:"HEGEVA ready",coreReady:"CORE READY"},
 hu:{primary:"Alaprendszerek",operations:"Műveletek",home:"Kezdőlap",command:"Vezérlőközpont",assistant:"Asszisztens",studio:"App Stúdió",business:"Üzleti központ",customers:"Ügyfelek",documents:"Dokumentumok",planner:"Tervező",reports:"Jelentések",messages:"Üzenetek",pricing:"Árak és csomagok",account:"Fiók",ready:"HEGEVA készen áll",coreReady:"A MAG KÉSZ"},
 de:{primary:"Kernsysteme",operations:"Betrieb",home:"Start",command:"Kommandozentrale",assistant:"Assistent",studio:"App Studio",business:"Business Hub",customers:"Kunden",documents:"Dokumente",planner:"Planer",reports:"Berichte",messages:"Nachrichten",pricing:"Preise & Pläne",account:"Konto",ready:"HEGEVA bereit",coreReady:"KERN BEREIT"},
 fr:{primary:"Systèmes principaux",operations:"Opérations",home:"Accueil",command:"Centre de commande",assistant:"Assistant",studio:"App Studio",business:"Espace Business",customers:"Clients",documents:"Documents",planner:"Planning",reports:"Rapports",messages:"Messages",pricing:"Prix et forfaits",account:"Compte",ready:"HEGEVA prêt",coreReady:"CŒUR PRÊT"},
 es:{primary:"Sistemas centrales",operations:"Operaciones",home:"Inicio",command:"Centro de mando",assistant:"Asistente",studio:"App Studio",business:"Centro Business",customers:"Clientes",documents:"Documentos",planner:"Planificador",reports:"Informes",messages:"Mensajes",pricing:"Precios y planes",account:"Cuenta",ready:"HEGEVA listo",coreReady:"NÚCLEO LISTO"},
} as const
...
export function DesktopCommandRail(){
 ...
 const groups=[
  ...
  {label:c.operations,items:[[BarChart3,c.business,"/business"],[Users,c.customers,"/business/customers"],[FileText,c.documents,"/business/documents"],[CalendarDays,c.planner,"/business/planner"],[BarChart3,c.reports,"/business/reports"],[MessageSquareText,c.messages,"/business/messages"],[Sparkles,c.pricing,"/pricing"]] as const},
 ]
