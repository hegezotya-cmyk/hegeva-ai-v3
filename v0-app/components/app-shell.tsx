  ...
  return (
    <div className="hegeva-atmosphere relative flex min-h-dvh flex-col overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        <div className="absolute left-1/2 top-44 h-[27rem] w-[27rem] -translate-x-1/2 rounded-full border border-cyan/[0.06]" />
        ...
        <div className="absolute bottom-[9%] left-[4%] hidden h-56 w-56 -rotate-12 rounded-full border border-gold/[0.055] lg:block" />
