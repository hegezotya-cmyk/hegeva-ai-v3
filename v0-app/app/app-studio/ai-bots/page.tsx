...
export default function AIBotsPage() { return <AIBotStudio afterContent={<main className="mx-auto w-full max-w-7xl min-w-0 px-4 py-8 sm:px-6 lg:px-8"><AIBotOwnerApprovalPanel /><AIBotExecution /></main>} /> }
