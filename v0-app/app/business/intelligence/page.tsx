...
export default function BusinessIntelligencePage(){const{locale}=useI18n(),c=COPY[locale];return <AppShell><main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8"><PageHeader eyebrow={c[0]} title={c[1]} subtitle={c[2]}/><div className="mt-8"><BusinessIntelligenceCenter/></div></main></AppShell>}
