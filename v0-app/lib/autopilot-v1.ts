...
export const DEFAULT_AUTOPILOT_POLICY:AutopilotPolicy={id:"workspace-policy",mode:"prepare",dailyLimit:3,allowedKinds:["overdue-invoice","neglected-lead","stale-quote","overdue-task","invoice-draft"],ownerApprovalRequired:true,updatedAt:""}
