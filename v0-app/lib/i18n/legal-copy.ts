...
const en: LegalSet = {
  ...
  privacy: { eyebrow:"HEGEVA AI · LEGAL", title:"Privacy notice", updated:"Last updated: 6 September 2026",
    ...
    sections:[
      ...
      {title:"Optional analytics",body:"If you choose Allow analytics, Google Analytics measures page visits and selected acquisition events such as registration starts. Analytics is disabled by default and is not loaded when you choose Essential only. We disable advertising storage, advertising personalisation and Google Signals, and do not intentionally send workspace records, form content or query parameters. You can change your choice at any time using Privacy choices."},
...
const hu: LegalSet = {
  ...
  privacy:{eyebrow:"HEGEVA AI · JOGI",title:"Adatvédelmi tájékoztató",updated:"Utolsó frissítés: 2026. szeptember 6.",
    ...
    sections:[
      ...
      {title:"Választható analitika",body:"Ha az Analytics engedélyezését választod, a Google Analytics oldalmegtekintéseket és kijelölt ügyfélszerzési eseményeket – például a regisztráció elindítását – mér. Az analitika alapból ki van kapcsolva, és a Csak szükséges választásnál nem töltődik be. A reklámtárolást, reklámszemélyre szabást és Google Signals használatát letiltjuk, munkaterületi adatot, űrlaptartalmat vagy query-paramétert pedig szándékosan nem küldünk. A választás az Adatvédelmi beállítások gombbal bármikor módosítható."},
