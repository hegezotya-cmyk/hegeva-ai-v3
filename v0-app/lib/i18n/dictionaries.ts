...
const dictionaries = {
  en: {
    ...
    capabilities: {
      ...
      core: { title: "HEGEVA Core Intelligence", desc: "Your business operating intelligence is active. HEGEVA analyses your workspace, surfaces priorities, identifies opportunities and prepares recommended next steps." },
...
const overrides: Partial<Record<Locale, DeepPartial<Dict>>> = {
  hu: {
    ...
    commandCenter: {
      ...
      previewNote: "Ez egy előnézet. A modulok a fiók összekapcsolása után csatlakoznak a Cloudflare-munkaterülethez — az oldalon nem jelenítünk meg szimulált adatokat."
    },
  ...
  de: {
    ...
    capabilities: { heading: "Was Sie mit HEGEVA AI tun können", subheading: "Ein Betriebssystem für Ihr gesamtes Unternehmen.", assistant: { title: "KI-Assistent", desc: "Ihr intelligenter Geschäftspartner, wenn Sie ihn brauchen." }, core: { title: "HEGEVA Core Intelligence", desc: "Ihre betriebliche Intelligenz ist aktiv. HEGEVA analysiert Ihren Arbeitsbereich, deckt Prioritäten auf, erkennt Chancen und bereitet empfohlene nächste Schritte vor." }, reports: { title: "Finanzberichte", desc: "Klare Berichte aus echten Geschäftsdaten." }, invoices: { title: "Rechnungsgenerator", desc: "Professionelle Rechnungen, Angebote und Belege." }, documents: { title: "Geschäftsdokumente", desc: "Verträge, Angebote und Vereinbarungen an einem Ort." }, crm: { title: "CRM & Kunden", desc: "Kunden, Leads und Nachfassaktionen zentral verwalten." }, studio: { title: "App Studio", desc: "Apps mit geführter KI planen, bauen und verbessern." } },
  ...
  fr: {
    ...
    capabilities: { heading: "Ce que vous pouvez faire avec HEGEVA AI", subheading: "Un seul système pour toute votre entreprise.", assistant: { title: "Assistant IA", desc: "Votre partenaire professionnel intelligent quand vous en avez besoin." }, core: { title: "HEGEVA Core Intelligence", desc: "Votre intelligence opérationnelle est active. HEGEVA analyse votre espace de travail, identifie les priorités, détecte les opportunités et prépare les prochaines actions recommandées." }, reports: { title: "Rapports financiers", desc: "Des rapports clairs à partir de vos données réelles." }, invoices: { title: "Générateur de factures", desc: "Factures, devis et reçus professionnels." }, documents: { title: "Documents professionnels", desc: "Contrats, propositions et accords au même endroit." }, crm: { title: "CRM et clients", desc: "Gérez clients, prospects et suivis au même endroit." }, studio: { title: "App Studio", desc: "Planifiez, créez et améliorez des applications avec une IA guidée." } },
